...
![img](F:/Java_notes/images-master/cs/design/refactor/primitive-obsession-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/primitive-obsession-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/primitive-obsession-3.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/replace-type-code-with-class-before.png)

**解决**

以一个新的类替换该数值类型码。

![img](F:/Java_notes/images-master/cs/design/refactor/replace-type-code-with-class-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/introduce-parameter-object-before.png)

**解决**

以一个对象来取代这些参数。

![img](F:/Java_notes/images-master/cs/design/refactor/introduce-parameter-object-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/replace-type-code-with-subclasses-before.png)

**解决**

以子类取代这个类型码。

![img](F:/Java_notes/images-master/cs/design/refactor/replace-type-code-with-subclasses-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/replace-type-code-with-state-strategy-before.png)

**解决**

以状态对象取代类型码。

![img](F:/Java_notes/images-master/cs/design/refactor/replace-type-code-with-state-strategy-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/data-clumps-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/data-clumps-3.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/large-class-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/large-class-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/large-class-3.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/extract-subclass-before.png)

**解决**

创建一个子类，并将用于特殊场景的特性置入其中。

![img](F:/Java_notes/images-master/cs/design/refactor/extract-subclass-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/extract-interface-before.png)

**解决**

移动相同的部分函数到接口中。

![img](F:/Java_notes/images-master/cs/design/refactor/extract-interface-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/duplicate-observed-data-before.png)

**解决**

一个比较好的方法是将负责 GUI 的数据放入一个独立的类，以确保 GUI 数据与域类之间的连接和同步。

![img](F:/Java_notes/images-master/cs/design/refactor/duplicate-observed-data-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/long-method-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/long-method-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/long-method-3.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/long-parameter-list-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/long-parameter-list-2.png)
