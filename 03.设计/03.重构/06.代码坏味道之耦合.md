...
![img](F:/Java_notes/images-master/cs/design/refactor/introduce-local-extension-before.png)

**解决**

建立一个新类，使它包含这些额外函数，让这个扩展品成为源类的子类或包装类。

![img](F:/Java_notes/images-master/cs/design/refactor/introduce-local-extension-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/middle-man-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/middle-man-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/remove-middle-man-before.png)

**解决**

让客户直接调用委托类。

![img](F:/Java_notes/images-master/cs/design/refactor/remove-middle-man-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/feature-envy-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/feature-envy-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/feature-envy-3.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/inappropriate-intimacy-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/inappropriate-intimacy-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/inappropriate-intimacy-3.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/move-field-before.png)

**解决**

在目标类新建一个字段，修改源字段的所有用户，令他们改用新字段。

![img](F:/Java_notes/images-master/cs/design/refactor/move-field-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/change-bidirectional-association-to-unidirectional-before.png)

**解决**

去除不必要的关联。

![img](F:/Java_notes/images-master/cs/design/refactor/change-bidirectional-association-to-unidirectional-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/hide-delegate-before.png)

**解决**

在服务类上建立客户所需的所有函数，用以隐藏委托关系。

![img](F:/Java_notes/images-master/cs/design/refactor/hide-delegate-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/replace-delegation-with-inheritance-before.png)

**解决**

在子类中新建一个字段用以保存超类；调整子类函数，令它改而委托超类；然后去掉两者之间的继承关系。

![img](F:/Java_notes/images-master/cs/design/refactor/replace-delegation-with-inheritance-after.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/message-chains-1.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/message-chains-2.png)
...
![img](F:/Java_notes/images-master/cs/design/refactor/message-chains-3.png)
