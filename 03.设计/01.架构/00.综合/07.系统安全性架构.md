...
![img](F:/Java_notes/images-master/snap/20200119202448.png)
...
![img](F:/Java_notes/images-master/snap/20200119210359.png)

### 角色继承

角色继承(Hierarchical Role) 就是指角色可以继承于其他角色，在拥有其他角色权限的同时，自己还可以关联额外的权限。这种设计可以给角色分组和分层，一定程度简化了权限管理工作。

![img](F:/Java_notes/images-master/snap/20200119210528.png)
