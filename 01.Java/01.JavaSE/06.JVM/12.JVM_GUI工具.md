...
![img](F:/Java_notes/images-master/snap/20200730151422.png)
...
![img](F:/Java_notes/images-master/snap/20200730150147.png)

### jvisualvm 监控页面

在 jvisualvm 监控页面，可以看到 Java 进程的 CPU、内存、类加载、线程的实时变化。

![img](F:/Java_notes/images-master/snap/20200730150254.png)

### jvisualvm 线程页面

jvisualvm 线程页面展示了当前的线程状态。

![img](F:/Java_notes/images-master/snap/20200730150416.png)

jvisualvm 还可以生成线程 Dump 文件，帮助进一步分析线程栈信息。

![img](F:/Java_notes/images-master/snap/20200730150830.png)
...
![img](F:/Java_notes/images-master/snap/20200308092746.png)

点击 Leak Suspects 可以进入内存泄漏页面。

（1）首先，可以查看饼图了解内存的整体消耗情况

![img](F:/Java_notes/images-master/snap/20200308150556.png)
...
![img](F:/Java_notes/images-master/snap/20200730145030.png)
