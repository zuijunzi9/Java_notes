...
![img](F:/Java_notes/images-master/cs/java/advanced/java-message-digest-process.jpg)
...
![img](F:/Java_notes/images-master/cs/java/advanced/symmetric-encryption.png)

假设甲乙方作为通信双方。假定甲乙双方在消息传递前已商定加密算法，欲完成一次消息传递需要经过如下步骤。

![img](F:/Java_notes/images-master/cs/java/advanced/symmetric-encryption-progress.png)
...
![img](F:/Java_notes/images-master/cs/java/advanced/password-based-encryption-progress.png)
...
![img](F:/Java_notes/images-master/cs/java/advanced/asymmetric-encryption.png)
